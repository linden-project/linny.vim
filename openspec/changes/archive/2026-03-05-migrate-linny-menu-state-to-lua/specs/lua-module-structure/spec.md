...
#### Scenario: Menu state accessible from main module
- **WHEN** calling `require('linny').menu.state.tab_init()`
- **THEN** it SHALL work the same as calling `require('linny.menu.state').tab_init()`
