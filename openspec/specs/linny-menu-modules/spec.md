# Capability: linny-menu-modules

## Purpose

Define the modular structure for the linny_menu system, which splits the monolithic menu implementation into focused autoload modules while maintaining backward compatibility and tab-local state.
